...
def draw_size_acc(data_dict,custom_path='./tmp',fn='Image_Size',img_title=None,suf=None): #highlight
    sx=[]
    sy=[]
    ...
    plt.ylabel("Accuracy")
    plt.xlabel(fn) #highlight
    plt.legend(loc="best") 
       
    plt.savefig(f'{custom_path}/{img_title}/{suf}/{fn}.png',dpi=300) #highlight
